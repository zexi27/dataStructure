 ...
 * @Package:com.zlq.day230
 * @ClassName: Day227_CheckArithmeticSubarrays
 * @description:
 * @author: LiQun
 * @CreateDate:2023/3/23 12:13
 */
/*
1630. 等差子数组
中等
...
-105 <= nums[i] <= 105
 */
public class Day227_CheckArithmeticSubarrays {
    ...
    public static List<Boolean> checkArithmeticSubarrays(int[] nums, int[] l, int[] r) {
        ...
        for (int i = 0; i < l.length; i++) {
            int left = l[i];
            int right = r[i];
            resList.add(isArithmetic2(nums, left, right));
        }
        return resList;
    }

    private static Boolean isArithmetic2(int[] nums, int left, int right) {
