 ...
 * @Package:com.zlq.day230
 * @ClassName: Day228_StreamChecker
 * @description:
 * @author: LiQun
 * @CreateDate:2023/3/24 10:10
 */
/*
1032. 字符流
提示
...
最多调用查询 4 * 104 次
 */
public class Day228_StreamChecker {
    public static void main(String[] args) {
        String[] words = {"cd", "f", "kl"};
        Day228_StreamChecker streamChecker = new Day228_StreamChecker(words);
    ...
    public Day228_StreamChecker(String[] words) {
        this.arr = words;
